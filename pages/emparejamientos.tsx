...
const players: Player[] = [
  { nombre: 'Player 99', faccion: 'Faction A', jugadas: 5, victorias: 3, empates: 1, derrotas: 1, puntos: 10 },
    ...
    <div style={{ height: '100vh', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ fontFamily: 'sans-serif', backgroundColor: '#333', color: 'white', margin: 0, padding: 0, borderRadius: '10px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', marginBottom: '20px' }}>
          <img src="/image1.jpg" alt="Image 1" style={{ width: '100px', height: '100px', borderRadius: '10px' }} />
          <img src="/image2.jpg" alt="Image 2" style={{ width: '100px', height: '100px', borderRadius: '10px' }} />
          <img src="/image3.jpg" alt="Image 3" style={{ width: '100px', height: '100px', borderRadius: '10px' }} />
        </div>
      </div>
    </div>
  );
